...
CREATE TABLE `experiment` (
  ...
  `path_exp` varchar(500) DEFAULT NULL,
  `fk_id_model` int NOT NULL,
  PRIMARY KEY (`id_experiment`),
  KEY `fk_Experiment_Model1_idx` (`fk_id_model`),
  CONSTRAINT `fk_Experiment_Model1` FOREIGN KEY (`fk_id_model`) REFERENCES `model` (`id_model`)
...
INSERT INTO `experiment` VALUES (1,'confusion matrix for validation set','static/storage/exp/val_cf.png',1),(2,'metrics for validation set','static/storage/exp/img_val_metrics.png',1),(3,'confusion matrix for test set','static/storage/exp/test_cf.png',1),(4,'metrics for test set','static/storage/exp/img_test_metrics.png',1);
...
INSERT INTO `model` VALUES (1,'vit-L32-version17-patch384-i018','vision transformer for diagnosis'),(2,'biomistral-7B-Q4','large language model for chatbot assistant');
...
INSERT INTO `scores` VALUES (1,1,0.99945),(1,2,0.99962),(1,3,0.00190),(1,4,0.00003),(1,5,0.99962),(1,6,0.08738),(1,7,0.99898),(1,8,0.99990),(1,9,0.99955),(1,10,0.99903),(1,11,0.00025),(1,12,0.00435),(1,13,0.00048),(1,16,0.00009),(1,17,0.00017),(1,18,0.00056),(1,20,0.00164),(1,21,0.00014),(2,1,0.00051),(2,2,0.00029),(2,3,0.78336),(2,4,0.99992),(2,5,0.00029),(2,6,0.07776),(2,7,0.00036),(2,8,0.00005),(2,9,0.00035),(2,10,0.00091),(2,11,0.99971),(2,12,0.99544),(2,13,0.99949),(2,16,0.00002),(2,17,0.99978),(2,18,0.99940),(2,20,0.99386),(2,21,0.99979),(3,1,0.00001),(3,2,0.00001),(3,3,0.00017),(3,4,0.00000),(3,5,0.00001),(3,6,0.01175),(3,7,0.00000),(3,8,0.00000),(3,9,0.00000),(3,10,0.00000),(3,11,0.00001),(3,12,0.00002),(3,13,0.00000),(3,16,0.00001),(3,17,0.00002),(3,18,0.00000),(3,20,0.00002),(3,21,0.00001),(4,1,0.00001),(4,2,0.00002),(4,3,0.21394),(4,4,0.00001),(4,5,0.00002),(4,6,0.63270),(4,7,0.00009),(4,8,0.00000),(4,9,0.00002),(4,10,0.00000),(4,11,0.00001),(4,12,0.00007),(4,13,0.00000),(4,16,0.99988),(4,17,0.00001),(4,18,0.00001),(4,20,0.00428),(4,21,0.00004),(5,1,0.00001),(5,2,0.00001),(5,3,0.00012),(5,4,0.00001),(5,5,0.00001),(5,6,0.00122),(5,7,0.00001),(5,8,0.00000),(5,9,0.00001),(5,10,0.00000),(5,11,0.00001),(5,12,0.00002),(5,13,0.00000),(5,16,0.00000),(5,17,0.00001),(5,18,0.00000),(5,20,0.00005),(5,21,0.00000),(6,1,0.00000),(6,2,0.00000),(6,3,0.00037),(6,4,0.00001),(6,5,0.00000),(6,6,0.17660),(6,7,0.00007),(6,8,0.00000),(6,9,0.00000),(6,10,0.00000),(6,11,0.00000),(6,12,0.00001),(6,13,0.00000),(6,16,0.00000),(6,17,0.00000),(6,18,0.00000),(6,20,0.00011),(6,21,0.00000),(7,1,0.00002),(7,2,0.00005),(7,3,0.00014),(7,4,0.00001),(7,5,0.00005),(7,6,0.01259),(7,7,0.00050),(7,8,0.00004),(7,9,0.00006),(7,10,0.00004),(7,11,0.00001),(7,12,0.00009),(7,13,0.00001),(7,16,0.00000),(7,17,0.00001),(7,18,0.00002),(7,20,0.00005),(7,21,0.00001);
...
--
/*!50003 DROP PROCEDURE IF EXISTS `sp_experiment_by_model` */;
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_experiment_by_model`(
	in p_id_model int
)
begin
...
/*!50003 DROP PROCEDURE IF EXISTS `sp_experiment_insert` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_experiment_insert`(
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_model_insert` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_model_insert`(
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vw_model` AS select `m`.`id_model` AS `id_model`,`m`.`name` AS `name`,`m`.`type` AS `type` from `model` `m` order by `m`.`id_model` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2024-05-15 20:32:37
